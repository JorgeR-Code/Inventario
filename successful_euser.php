        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">Actualización exitosa</h1>
                        <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="panel_usuarios1.php">Panel</a></li>
                            <li class="breadcrumb-item"><a href="user_list.php">Lista de usuarios</a></li>
                            <li class="breadcrumb-item"><a href="edit.php">Editar usuario</a></li>
                            <li class="breadcrumb-item active">Actualización exitosa</li>
                        </ol>
                    <div class="container">
