...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = sprintf("INSERT INTO usuarios (id, nombre, apellido, telefono, acceso, password) VALUES (%s, %s, %s, %s, %s, %s)",
    GetSQLValueString($_POST['id'], "int"),
    GetSQLValueString($_POST['nombre'], "text"),
    GetSQLValueString($_POST['apellido'], "text"),
    GetSQLValueString($_POST['telefono'], "text"),
    GetSQLValueString($_POST['acceso'], "int"),
    GetSQLValueString($_POST['password'], "text"));

    mysql_select_db($database_db, $db);
        $Result1 = mysql_query($insertSQL, $db) or die(mysql_error());

        $insertGoTo = "successful_registration.php";
            if (isset($_SERVER['QUERY_STRING'])) {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Agregar un nuevo usuario</h3></div>
                                    <div class="card-body">
                                        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3" id="grupo__telefono">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputPhone" type="text" name="telefono" placeholder="Enter the phone number" />
                                                        <i class="formulario__validation-estado fas fa-times-circle"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6  mb-3" id="grupo__contraseña">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputPassword" name="password" type="password" placeholder="Create a password" />
                                                        <i class="formulario__validation-estado fas fa-times-circle"></i>

                                                        <label class="formulario__label" for="inputPassword">Contraseña</label>
                                                    </div>
                                                    <p class="formulario__input-error">La contraseña debe ser de 4 a 15 dígitos.</p>

                                                </div>
                                                <div class="col-md-6  mb-3" id="grupo__confirmContraseña">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputPasswordConfirm" name="passwordConfirm" type="password" placeholder="Confirm password" />
                                                        <i class="formulario__validation-estado fas fa-times-circle"></i>

                                                        <label class="formulario__label" for="inputPasswordConfirm">Confirmar contraseña</label>
                                                    </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input type="submit" id="agregarId" class="btn btn-primary btn-block" value="Agregar"/></div>
                                            </div>
